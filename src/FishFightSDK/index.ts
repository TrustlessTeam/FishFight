...
class FishFight {
    ...
    constructor(){
        ...
        this.readRedgill = this.setContract(this.provider, ERC20Abi, Constants._redgillAddress)
    ...
    setProviderWallet = (providerWallet: HarmonyExtension | Web3, type: "web3" | "harmony") => {
        ...
        this.redgill = this.setContract(this.providerWallet, ERC20Abi, Constants._redgillAddress)
